...
const Accordion = () => {
    ...
    return (
        <div className="faq-sec faq-sec1 relative z-20 overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
            <div className="cursor5"></div>

            <div className="container relative mx-auto my-auto w-3/4">
                ...
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-90 px-4 text-black lg:w-1/2">
                        <AccordionItem
